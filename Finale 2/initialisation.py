...
route-map COSTUMER_RM_PERMIT permit 10
	set community 100:1789


router bgp 104
	bgp community new-format 
	address-family ipv6 unicast
		neighbor 2001:0:104:6::2 route-map COSTUMER_RM_PERMIT in
		neighbor 2001:DB8::1 send-community both


#pr les providers/peers

route-map COSTUMER_RM_DENY permit 10
	match community COSTUMER_CL
route-map COSTUMER_RM_DENY deny 20

ip community-list standard COSTUMER_CL permit 100:1789

router bgp 104
	bgp community new-format
	address-family ipv6 unicast
		neighbor 2001:0:104:6::2 route-map COSTUMER_RM_DENY out
		neighbor 2001:DB8::1 send-community both
